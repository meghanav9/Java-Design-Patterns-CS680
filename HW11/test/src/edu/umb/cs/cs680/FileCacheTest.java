...
public class FileCacheTest {
	...
	@Test
	public void setCacheReplacementPolicy_Test(){
		CacheReplacementPolicy instance1 = FIFO.getInstance();
		assertThat(FileCache.setCacheReplacementPolicy(),is(instance1));
	}	
